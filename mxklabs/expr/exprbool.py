...
class LogicalAnd(ex.Expr):
  ...
  def __init__(self, *args):
    ex.Expr.__init__(self, type=et.Bool(), nodestr="logical-and", children=args)
...
class LogicalOr(ex.Expr):
  ...
  def __init__(self, *args):
    ex.Expr.__init__(self, type=et.Bool(), nodestr="logical-or", children=args)
...
class LogicalNot(ex.Expr):
  ...
  def __init__(self, arg):
    ex.Expr.__init__(self, type=et.Bool(), nodestr="logical-not", children=[arg])
